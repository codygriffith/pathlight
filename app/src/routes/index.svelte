...
<div class="flex flex-col items-center m-auto w-[100%] mt-16 mb-4">
	...
	<div class="sm:px-6 lg:px-0 w-full min-w-full lg:min-w-0 lg:w-[70vw]">
		<div class="mt-8 flex flex-col mb-10 ml-2">
			<div class="overflow-x-auto sm:-mx-6 lg:-mx-8 drop-shadow-[0.5vw_0.6vw_1.5vw_#00000071] pr-2">

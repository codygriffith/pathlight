...
<div class="flex flex-col items-center m-auto w-[100%] mt-16 mb-4">
	...
	<div class="px-4 sm:px-6 lg:px-0 w-full min-w-full lg:min-w-0 lg:w-[70vw]">
		<div class="mt-8 flex flex-col mb-10 ml-2">
			<div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8 drop-shadow-[0.5vw_0.6vw_1.5vw_#00000071] pr-2">
						...
						<table class="min-w-full divide-y divide-gray-300 ">
							<thead class="bg-gray-50 justify-between text-sm lg:text-lg">
								<tr>
									...
									<th scope="col" class="px-3 py-3.5 text-left font-semibold text-gray-900 whitespace-nowrap">
										<div class="flex">
											<div>Perf</div>
											<div class="lg:hidden">.</div>
											<div class="hidden lg:inline">ormance</div>
										</div>
									</th>
									<th scope="col" class="px-3 py-3.5 text-left font-semibold text-gray-900 whitespace-nowrap">
										<div class="flex">
											...
											<span class="hidden lg:inline">ibility</span>
										</div>
									</th>
									<th scope="col" class="px-3 py-3.5 text-left font-semibold text-gray-900 whitespace-nowrap">
										<div class="flex">
											Best Prac
											<span class="lg:hidden">.</span>
											<span class="hidden lg:block">tices</span>
										</div>
									</th>
									<th scope="col" class="px-3 py-3.5 text-left font-semibold text-gray-900 whitespace-nowrap">SEO</th>

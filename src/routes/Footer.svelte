<footer class="flex flex-col-reverse sm:flex-row w-full items-center justify-between px-5 sm:px-12 lg:px-20 2xl:px-72 bg-gray-200 dark:bg-slate-800 text-slate-700 dark:text-slate-300">

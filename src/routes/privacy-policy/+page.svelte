...
<div class="max-w-[60rem] break-words mb-16 px-6">
	...
	<h2>Use of Data</h2>
	<p>Pathlight uses the collected data for various purposes:</p>
	<ul>
	...
	<h2>Advertising</h2>
	<p>
		We may use third-party Service Providers to show advertisements to you to help support and maintain our Service. These third-party service providers may use cookies to collect information about
		your visit to our Service and other websites, in order to show you advertisements that may be of interest to you.
	</p>
	<ul>
		<li>
			Third party vendors, including Google, use cookies to serve ads based on a user's prior visits to your website or other websites. Google's use of advertising cookies enables it and its partners
			to serve ads to your users based on their visit to your sites and/or other sites on the Internet.
		</li>
		<li>
			Users may opt-out of personalized advertising by visiting Ads Settings. Alternatively, you can direct users to opt-out of a third-party vendor's use of cookies for personalized advertising by
			visiting <a href="http://www.aboutads.info" target="_new">www.aboutads.info</a>.
		</li>
	</ul>
	...
	<p>
		We do not knowingly collect personally identifiable information from anyone under the age of 18. If you are a parent or guardian and you are aware that your Children has provided us with Personal
		Data, please contact us. If we become aware that we have collected Personal Data from children without verification of parental consent, we take steps to remove that information from our servers.
	</p>
	<h2>Security</h2>
	<p>
	...
	<ul>
		<li>By email: <a href="mailto:privacy@pathlight.dev" target="_new">privacy@pathlight.dev</a></li>
		<li>By visiting this page on our website: <a href="https://pathlight.dev/contact" target="_new">https://pathlight.dev/contact</a></li>
	</ul>
	<time>Effective Date: February 23, 2023</time>
</div>
